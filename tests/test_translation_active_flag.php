...
assert(substr_count($moduleSource, '$this->GetEffectiveSelectedLanguage(') === 6, 'the effective-language helper must be used at all 6 write sites (ApplyLanguage x2 for names+texts, ApplyAutomationsLanguage, ApplyGreetingLanguage, ApplyChartsLanguage, ApplyEnumerationOptionsToVariable)');
